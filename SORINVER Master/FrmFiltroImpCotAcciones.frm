...
Begin VB.Form FrmFiltroImpCotAcciones 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Importación cotizaciones Acciones"
   ClientHeight    =   1560
   ClientLeft      =   4155
   ClientTop       =   3870
   ClientWidth     =   5910
   ...
   EndProperty
   Icon            =   "FrmFiltroImpCotAcciones.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmFiltroImpCotAcciones"
...
LProgreso.Caption = "1 de 3 - Cargando Acciones para importacion"
FrmPrincipal.StatusBar1.Panels(3).Text = "1 de 3 - Cargando Acciones para importacion"
...
CargarAccionesImportacionCotizaciones ("Yahoo")

LProgreso.Caption = "2 de 3 - Descargando Acciones para importacion"
FrmPrincipal.StatusBar1.Panels(3).Text = "2 de 3 - Descargando Acciones para importacion"
...
DescargarAccionesImportacionCotizaciones ("Yahoo")

BarraProgreso.Value = 20

LProgreso.Caption = "3 de 3 - Recogiendo Acciones para importacion"
FrmPrincipal.StatusBar1.Panels(3).Text = "3 de 3 - Recogiendo Acciones para importacion"

LComentario.Caption = ""

DoEvents

RecogerAccionesImportacionCotizacionesFSO
